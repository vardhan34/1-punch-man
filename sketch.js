...
function preload(){
  ...
  kangaroo_running =   loadAnimation("assets/punch3.png","assets/punchman1.png");
  kangaroo_collided = loadAnimation("assets/punch4.png");
  jungleImage = loadImage("assets/punch bac1.jpg");
...
function setup() {
  ...
  kangaroo = createSprite(50,displayHeight-100,20,50);
  ...
  restart = createSprite(displayWidth/2+150,displayHeight/2+100);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    ...
    var shrub = createSprite(camera.position.x+500,displayHeight-80,40,10);
...
function spawnObstacles() {
  if(frameCount % 120 === 0) {
    ...
    var obstacle = createSprite(camera.position.x+400,displayHeight-200,40,40);
